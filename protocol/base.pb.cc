...
client_register::client_register(const client_register &from)
    ...
    if (!from._internal_nicheng().empty()) {
        nicheng_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_nicheng(),
                     GetArena());
    }
    ...
    if (!from._internal_touxiang().empty()) {
        touxiang_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_touxiang(),
                      GetArena());
    }
    cmd_ = from.cmd_;
...
// @@protoc_insertion_point(class_specific_merge_from_start:client_register)
    ...
    if (from.nicheng().size() > 0) {
        _internal_set_nicheng(from._internal_nicheng());
    }
    if (from.email().size() > 0) {
        _internal_set_email(from._internal_email());
    }
    if (from.touxiang().size() > 0) {
        _internal_set_touxiang(from._internal_touxiang());
    }
    if (from.cmd() != 0) {
        _internal_set_cmd(from._internal_cmd());
    }
...
void client_register::InternalSwap(client_register *other) {
    ...
    username_.Swap(&other->username_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
    passwd_.Swap(&other->passwd_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
    nicheng_.Swap(&other->nicheng_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
    email_.Swap(&other->email_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
    touxiang_.Swap(&other->touxiang_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
    swap(cmd_, other->cmd_);
}
...
void server_user_infor::InternalSwap(server_user_infor *other) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::memswap<
            PROTOBUF_FIELD_OFFSET(server_user_infor, code_)
            + sizeof(server_user_infor::code_)
            - PROTOBUF_FIELD_OFFSET(server_user_infor, cmd_)>(
            reinterpret_cast<char *>(&cmd_),
            reinterpret_cast<char *>(&other->cmd_));
}
...
requestResources::requestResources(::PROTOBUF_NAMESPACE_ID::Arena *arena)
        : ::PROTOBUF_NAMESPACE_ID::Message(arena) {
    SharedCtor();
    RegisterArenaDtor(arena);
    // @@protoc_insertion_point(arena_constructor:requestResources)
}
...
void requestResources::ArenaDtor(void *object) {
    requestResources *_this = reinterpret_cast< requestResources * >(object);
    (void) _this;
}

void requestResources::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena *) {
}
...
responseResources::responseResources(::PROTOBUF_NAMESPACE_ID::Arena *arena)
        : ::PROTOBUF_NAMESPACE_ID::Message(arena) {
    SharedCtor();
    RegisterArenaDtor(arena);
    // @@protoc_insertion_point(arena_constructor:responseResources)
}
...
void responseResources::ArenaDtor(void *object) {
    responseResources *_this = reinterpret_cast< responseResources * >(object);
    (void) _this;
}

void responseResources::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena *) {
}
...
PROTOBUF_NAMESPACE_OPEN
        ...
        PROTOBUF_NOINLINE ::requestResources *Arena::CreateMaybeMessage<::requestResources>(Arena *arena) {
            return Arena::CreateMessageInternal<::requestResources>(arena);
        }

        template<>
        PROTOBUF_NOINLINE ::responseResources *Arena::CreateMaybeMessage<::responseResources>(Arena *arena) {
            return Arena::CreateMessageInternal<::responseResources>(arena);
        }
